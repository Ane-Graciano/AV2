        ...
        return(
            <>
                <section className="relative">
                    ...
                    <select name={this.props.name} value={this.props.value} id={this.props.name} onChange={this.props.onChange} required={this.props.required} disabled={this.props.disabled} className={`w-[300px] block px-2 pb-1 pt-5 text-sm text-gray-950 border-b-2 border-[#c0c0c0]  focus:outline-none focus:border-[#3a6ea5] peer  ${this.props.classNameSelect}`}>
